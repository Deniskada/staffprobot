...
from apps.web.routes import auth, dashboard, objects, timeslots, calendar, shifts, reports, contracts, users, employees, templates
...
app.include_router(templates.router, prefix="/templates", tags=["Шаблоны планирования"])
