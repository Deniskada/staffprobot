...
- **Файлы:**
  - `core/celery/tasks/reminder_tasks.py` — удален неиспользуемый код создания `NotificationService()`, исправлена логика проверки рабочего времени для уведомлений (~10 строк изменений)
