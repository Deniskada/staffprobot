...
**Статус:** Активно используется + Админ-панель
...
2. [🆕 Админ-панель управления](#админ-панель-управления)
3. [Каналы доставки](#каналы-доставки)
4. [Типы уведомлений](#типы-уведомлений)
5. [Приоритеты](#приоритеты)
6. [Статусы уведомлений](#статусы-уведомлений)
...
- **Фильтрация:**
  - По статусу (pending, sent, delivered, failed, read, cancelled)
...
### 📝 Управление шаблонами (Фаза 2-3)

**Статус:** ✅ Просмотр реализован, редактирование - в разработке

#### Список шаблонов (`/admin/notifications/templates`)
- Просмотр всех 26 статических шаблонов
...
#### Просмотр шаблона (`/admin/notifications/templates/{id}`)
- Детальная информация о шаблоне
- Предпросмотр Plain Text и HTML версий
- Список доступных переменных
- Тестирование шаблона с JSON данными
- История использования (планируется)
...
### 🚧 В разработке (Iteration 25, Фазы 2-4)
