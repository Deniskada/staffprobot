...
**Статус:** В работе (Фаза 1: 14/14 задач ✅, Фаза 2: 2/2 задач ✅, Фаза 3: 14/21 задач)  
**Дата:** 5 ноября 2025  
**Приоритет:** Высокий  
...
- [ ] **Фаза 4: Сотрудник**
  - [ ] 4.1. Календарь сотрудника: убрать drag&drop панели, подключить новую логику занятости и статусные подписи
  - [ ] 4.2. Планирование смен сотрудника: страница по клику на смену/тайм-слот (аналог owner/manager) с автоопределением сотрудника, предзаполнением объекта и загрузкой свободных тайм-слотов, включая трэки
  - [ ] 4.3. API и валидации: расширить endpoints, обновить проверки и документацию, добавить тесты под новый сценарий планирования сотрудника
