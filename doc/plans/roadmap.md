...
**Статус:** В работе (Фаза 1: 14/14 задач ✅, Фаза 2: 2/2 задач ✅, Фаза 3: 11/21 задач)  
**Дата:** 5 ноября 2025  
**Приоритет:** Высокий  
...
- [ ] **Фаза 3: Управляющий**
  ...
  - [ ] 3.9. Страница `/manager/timeslots/object/{object_id}`:
    - [ ] В модалке "Массовое редактирование тайм-слотов" убрать пункт "Игнорировать задачи объекта"
    - [ ] Добавить вместо него пункт "Отменить штрафы за опоздания"
    - [ ] Обработать применение изменений, если нажато поле "Отменить штрафы за опоздания"
    - [ ] Проверить обработчики всех остальных полей модалки
  - [ ] 3.10. Формы тайм-слотов для управляющего:
    - [ ] На странице `/manager/timeslots/object/{object_id}/create` убрать поле "Игнорировать задачи объекта"
    - [ ] На странице `/manager/timeslots/object/{object_id}/edit` убрать поле "Игнорировать задачи объекта"
