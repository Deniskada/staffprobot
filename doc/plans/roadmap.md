...
- [ ] Нормализовать уведомления о сменах: переименовать `SHIFT_CONFIRMED` в «Планирование смены сотрудником», реализовать полный набор сменных уведомлений (планирование, открытие, закрытие, отмена, напоминание), обновить Celery/триггеры, документацию и настройки каналов.
