...
**Статус:** В работе (Фаза 1: 14/14 задач ✅, Фаза 2: 2/2 задач ✅, Фаза 3: 5/21 задач)  
**Дата:** 5 ноября 2025  
**Приоритет:** Высокий  
...
- [ ] **Фаза 3: Управляющий**
  ...
  - [ ] 3.2. Страница `/manager/objects`:
    - [ ] Убрать существующие фильтры
    - [ ] Реализовать фильтрацию, сортировку и пагинацию такие же как на `/owner/shifts/`
  - [ ] 3.3. Страница `/manager/employees`:
    - [ ] Реализовать сортировку и пагинацию такие же как на `/owner/shifts/`
  - [ ] 3.4. Страница `/manager/contracts/{contract_id}/edit`:
    - [ ] В разделе "Доступ к объектам" вместо надписи "У вас нет доступных объектов для назначения." выводить перечень всех объектов, доступных управляющему по договору, в котором есть объект, указанный в редактируемом договоре сотрудника
  - [ ] 3.5. Страница `/manager/employees/{employee_id}/shifts`:
    - [ ] Исправить отображение времени смен с учетом временной зоны объекта
  - [ ] 3.6. Страница планирования смен для управляющего:
    - [ ] На основании модальной формы "Планирование смен", которая находится на странице `/manager/shifts`, создать новую страницу планирования смен, чтобы она разворачивалась и умещалась на весь экран
