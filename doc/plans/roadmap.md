...
**Статус:** В работе (Фаза 1: 14/14 задач ✅, Фаза 2: 2/2 задач ✅, Фаза 3: 13/21 задач)  
**Дата:** 5 ноября 2025  
**Приоритет:** Высокий  
...
- [ ] **Фаза 3: Управляющий**
  ...
  - [ ] 3.13. Меню управляющего:
    - [x] Добавить меню "Задачи" с раскрывающимися подменю (как у владельца)
    - [x] Добавить меню "Инциденты" (как у владельца)
