...
**Статус:** 🔄 В процессе (анализ биллинга)  
**Дата:** 31 октября 2025  
...
- [ ] **1. Анализ существующего биллинга (1 день)**
  - [ ] 1.1. Изучить `apps/web/services/billing_service.py`
  - [ ] 1.2. Изучить `domain/entities/billing_transaction.py`
  - [ ] 1.3. Изучить `domain/entities/user_subscription.py`
  - [ ] 1.4. Определить: для кого биллинг (владельцы или сотрудники)
  - [ ] 1.5. Проанализировать интеграцию с платежными системами

- [ ] **2. Планирование интеграции с YooKassa (1 день)**
  - [ ] 2.1. Изучить API YooKassa (SDK, вебхуки, callbacks)
  - [ ] 2.2. Спроектировать архитектуру платежей для владельцев
  - [ ] 2.3. Определить жизненный цикл подписки
  - [ ] 2.4. Спроектировать обработку вебхуков от YooKassa

- [ ] **3. Реализация интеграции с YooKassa (3-5 дней)**
  - [ ] 3.1. Установка и настройка SDK YooKassa
  - [ ] 3.2. Создание платежей через YooKassa
  - [ ] 3.3. Обработка вебхуков (success, failed, pending)
  - [ ] 3.4. Обновление подписок владельцев
  - [ ] 3.5. UI для управления подписками

- [ ] **4. Тестирование и документация (1 день)**
  - [ ] 4.1. Тестирование платежей в sandbox YooKassa
  - [ ] 4.2. Обработка edge cases (таймауты, дубликаты)
  - [ ] 4.3. Документация интеграции
  - [ ] 4.4. Обновление roadmap

### Результат:

- ✅ Полное понимание текущего биллинга
- ✅ Интеграция с YooKassa для приёма оплат
- ✅ Автоматическое управление подписками владельцев
- ✅ Уведомления о платежах (Iteration 38, типы SUBSCRIPTION_EXPIRING, SUBSCRIPTION_EXPIRED)

### DoD:

- [ ] Анализ биллинга завершён и задокументирован
