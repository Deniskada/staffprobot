...
- [x] **1.6. Унификация стилей навигации календаря (1 день)**
  - Type: ux | Files: apps/web/templates/shared/calendar/grid_unified.html, apps/web/static/css/shared/calendar.css
  - Acceptance: навигация, фильтры, легенда в едином строгом стиле, компактно расположены
  - **Детали реализации:**
    - Упрощены градиенты кнопок
    - Уменьшен размер элементов навигации
    - Компактное расположение фильтров в одну строку
    - Унифицированы цвета и отступы
  - **Примечание:** Отложено до получения дизайн-макета
