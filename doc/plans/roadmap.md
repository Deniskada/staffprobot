...
**Статус:** В работе (Фаза 1: 14/14 задач ✅, Фаза 2: 2/2 задач ✅, Фаза 3: 9/21 задач)  
**Дата:** 5 ноября 2025  
**Приоритет:** Высокий  
...
- [ ] **Фаза 3: Управляющий**
  ...
  - [ ] 3.7. Календарь (`/manager/calendar`):
    - [ ] 3.7.1. При клике на пустой день сделать поведение таким же как у владельца: открывается форма быстрого планирования тайм-слота с подставлением объекта (если он выбран в фильтре) и расчетом свободных окон в работе объекта
    - [ ] 3.7.2. При клике на запланированную смену сделать поведение таким же как у владельца: открывается форма планирования смен, созданная в пункте 3.6. После нажатия "Запланировать смены" происходит возврат в календарь, если форма вызвана из календаря, и в смены, если оттуда
    - [ ] 3.7.3. Убрать drag&drop формы объектов и сотрудников в календаре
