...
**Статус:** В работе (Фаза 1: 14/14 задач ✅, Фаза 2: 2/2 задач ✅, Фаза 3: 10/21 задач)  
**Дата:** 5 ноября 2025  
**Приоритет:** Высокий  
...
- [ ] **Фаза 3: Управляющий**
  ...
  - [ ] 3.8. Страница `/manager/timeslots`:
    - [ ] Сделать табличное представление по умолчанию
    - [ ] Реализовать фильтрацию и сортировку такие же как на странице `/owner/timeslots/`
