...
## Итерация 47: Учёт даты увольнения при определении активности контракта (план)
...
**План:** См. `doc/plans/ITERATION_47_CONTRACT_TERMINATION_DATE.md`
