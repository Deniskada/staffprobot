...
- [x] **1. Добавить ссылку на бота на странице входа (1 час)**
  - [x] 1.1. Добавить кнопку "Открыть бота в Telegram" на странице входа
...
- [x] **2. Уточнить текст "Макс. расстояние" (30 минут)**
  - [x] 2.1. Заменить "Макс. расстояние" на "Макс. расстояние от объекта для геолокации"
...
- [x] **3. Исправить баг с двойным @ в username (45 минут)**
  - [x] 3.1. Добавить проверку username.startswith('@') во всех шаблонах
...
- [x] **4. Изменить placeholder в полях "Почасовая ставка" (30 минут)**
  - [x] 4.1. Заменить placeholder "500" на "Введите сумму"
