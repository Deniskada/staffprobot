...
**Итерация 39 (Billing & YooKassa Integration):** 🔄 В процессе (анализ биллинга)
...
- [ ] **Фаза 1: Установка и настройка SDK YooKassa (0.5 дня)**
  - [ ] 1.1. Добавить `yookassa` в `requirements.txt`
  - [ ] 1.2. Добавить переменные окружения (YOOKASSA_SHOP_ID, YOOKASSA_SECRET_KEY)
  - [ ] 1.3. Создать `apps/web/services/payment_gateway/yookassa_service.py`

- [ ] **Фаза 2: Создание платежей для владельцев (1 день)**
  - [ ] 2.1. Создать `apps/web/routes/owner_subscription.py`
  - [ ] 2.2. Роуты: `/owner/tariffs`, `/owner/subscription`, `/owner/billing/transactions`
  - [ ] 2.3. Интеграция YooKassa в создание платежа
  - [ ] 2.4. Шаблоны для владельцев

- [ ] **Фаза 3: Обработка вебхуков от YooKassa (1.5 дня)**
  - [ ] 3.1. Создать `apps/web/routes/webhooks.py`
  - [ ] 3.2. Роут `POST /api/webhooks/yookassa`
  - [ ] 3.3. Обработка статусов: succeeded, canceled, waiting_for_capture
  - [ ] 3.4. Обновление подписок после успешной оплаты

- [ ] **Фаза 4: Автоматическое продление подписок (1 день)**
  - [ ] 4.1. Создать `core/celery/tasks/billing_tasks.py`
  - [ ] 4.2. Задачи: `check_expiring_subscriptions`, `check_expired_subscriptions`
  - [ ] 4.3. Автоматическое создание платежа при автопродлении

- [ ] **Фаза 5: UI для владельцев (1 день)**
  - [ ] 5.1. Страница выбора тарифа (`owner/tariffs.html`)
  - [ ] 5.2. Страница управления подпиской (`owner/subscription.html`)
  - [ ] 5.3. Страница истории транзакций (`owner/billing/transactions.html`)

- [ ] **Фаза 6: Тестирование и документация (0.5 дня)**
  - [ ] 6.1. Тестирование в sandbox YooKassa
  - [ ] 6.2. Обработка edge cases (дубликаты вебхуков)
  - [ ] 6.3. Документация интеграции
  - [ ] 6.4. Обновление roadmap
...
- [ ] YooKassa интегрирован и работает в sandbox
- [ ] Обработка вебхуков реализована
- [ ] Роуты для владельцев созданы
- [ ] UI для управления подписками готов
