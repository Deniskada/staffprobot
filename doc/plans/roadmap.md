...
**Итерация 25 (Admin Notifications Management):** В разработке - Фаза 1 ✅ завершена (3/3 задачи)  
...
- [x] **Фаза 1:** Дашборд и статистика (3 дня) ✅
  ...
  - [x] 1.3. Создать дашборд (`dashboard.html`)
  - [x] Добавить пункт "Уведомления" в навигацию админки
  - [x] Исправлена ошибка инициализации `AdminNotificationService`
