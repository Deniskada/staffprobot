...
- При сомнениях - расширить поиск по коду и перечитать контекст (файл целиком)
...
2. Сделать поиск по коду, прочитать релевантные файлы и свериться с `.cursor/rules/staffprobot.mdc`
